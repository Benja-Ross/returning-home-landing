...
export const missionAndMethod: MissionAndMethodContent = {
  ...
  opening: [
    "We care about the world we inhabit. How could we not? It’s the only home we’ve got. Life can be challenging, but when something happens like an unanticipated sunset bringing seemingly impossible color to the horizon, or being witness to a great act of kindness, we are reminded of how good it is to be here.",
    ...
    "But many of us also see that people, places, and the Earth as a whole are experiencing deep fragmentation. The challenges we face are complex and interconnected. No individual can stand alone.",

    "When we look out at what’s happening, we can feel isolated and overwhelmed while the larger picture, and what we can do, has become harder to see. Without shared understanding and purpose, shared direction and action, and sturdy webs of relationship, our efforts remain scattered and insufficient.",
  ...
  chapters: {
    remembering: [
      "In this chapter, people share real stories about the places where they live. Through participatory storytelling, neighbors surface what makes a place home, and in doing so they tend to what makes shared direction and a sense of togetherness possible.",

      "In a world where our attention is so often scattered and elsewhere, stories of place surface what is too often overlooked or hidden in plain sight. We may learn of a group doing something inspiring right down the street. We may learn beavers have returned to a local river and the river’s character has changed. We may hear a story of the first time someone new to the area really felt at home, and thus see our own home with new eyes. We may learn of a project that is good or even necessary for all but in critical need of help.",

      "As stories accumulate, people see more connections between their experiences. A shared picture, one that includes differences, naturally forms. And there’s a moment in the storytelling when we realize the deeper purpose in it all, that we’re not only seeing our place more clearly, but our attention is aligning."
    ],

    revealing: [
      "In this chapter, the group pauses and looks at their stories together. This phase is for reflecting and engaging collective intelligence to make sense of previously shared stories in a way no one could do alone.",

      "In a fragmented culture, individual stories placed side by side do not automatically form a clear shared picture. Often there is obvious connection and overlap, but this is also a moment when our fragmentation can become more visible. What is needed is a shared foundation to start, a kind of map that enables our stories to sit in proximity. From there, we create space to pause, reflect, and notice emerging patterns and possibilities for connection.",

      "We are finding it helpful to use simple, game-like formats to support all of this. Clear phases and questions can help the group shift perspective. When people understand the structure, their trust and patience grows, patterns more easily surface, and shared direction can begin to take shape.",

      "Shared intention does not arrive fully formed, nor at the same time for everyone. But with structure and care, alignment becomes possible.",

      "When that alignment forms, it can feel energizing. Something that was diffuse begins to gather. The group begins to sense what their place is asking of them."
    ],

    reconnecting: [
      "In this chapter, groups bring what they’ve learned into a conversation with the physical world.",

      "When the group has moved through thoughtful reflection and begun to see from a shared perspective, a next step often becomes surprisingly clear. It doesn’t need to be a big step, it simply needs to feel aligned with what the group has heard and sensed together. The group knows it has arrived at a worthy step when it feels it has emerged somehow on its own.",
      ...
      "Walking our stories into the world generates feedback. What has formed within the group deepens: shared meaning, direction, purpose, attention, and intention. This is when the value in the cyclical nature of the overall practice becomes clear."
    ]
  },
  ...
  howThisGrows: [
    ...
    "Our intention is steady development rather than rapid expansion, planting seeds of the practice where the soil is ready and moving at a pace that strengthens relationships rather than straining them.",
  ...
  benjiNote: {
    bullets: [
      "This work is larger than any one person.",
      "It has grown through relationships, experimentation, and care.",
      "My background in regenerative agriculture and years of living with chronic illness have shaped how I understand wholeness, resilience, and will.",
      "I remain a learner within this practice."
    ],

    closing:
      "This space exists simply to offer a human presence behind the work — not a title, not a claim of ownership, but a face and a voice devoted to helping places grow in coherence over time."
  }
}