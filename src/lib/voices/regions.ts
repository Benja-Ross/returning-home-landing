...
export const REGIONS: Record<string, RegionConfig> = {
  "erie-niagara": {
    ...
    stewards: [],
    introParagraphs: [
      "Voices is a space for the Erie-Niagara region to deepen connection to place and share reflections.",
    ],
  ...
  "ann-arbor": {
    ...
    stewards: [],
    introParagraphs: [
      "Voices supports the Ann Arbor community in the Returning Home practice.",
    ],
    neighborhoodHint: "If someone from your region asked you where you live, what would you say?",
    hearingSummary:
